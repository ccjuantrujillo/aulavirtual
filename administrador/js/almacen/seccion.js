...
//     });        
    ...
    $("body").on("click","#nuevo",function(){
        dataString = "";
        url = base_url+"index.php/seccion/editar/n";
    ...
    $("body").on("click","#limpiar",function(){
        url = base_url+"index.php/seccion/listar";
        location.href=url;
    });
    
    $("body").on("click","#grabar",function(){
        url = base_url+"index.php/seccion/grabar";
        dataString  = $('#frmPersona').serialize();
        $.post(url,dataString,function(data){
            alert('Operacion realizada con exito');
            location.href = base_url+"index.php/seccion/listar";
        });        
    ...
    $("body").on('change',"#ciclo",function(){
        url    = base_url+"index.php/periodo/obtener/";
        objRes = new Object();
...
function editar(codigo){
    ...
    url = base_url+"index.php/seccion/editar/e/"+codigo;
    $.post(url,dataString,function(data){
        $('#basic-modal-content').modal();
        $('#mensaje').html(data);
    });           
...
function eliminar(codigo){
    if(confirm('Esta seguro desea eliminar esta semana?')){
        dataString = "codigo="+codigo;
        url = base_url+"index.php/seccion/eliminar";
        $.post(url,dataString,function(data){
