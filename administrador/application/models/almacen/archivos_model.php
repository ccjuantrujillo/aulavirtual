...
class Archivos_model extends CI_Model{
    ...
    public function listar($filter,$filter_not="",$number_items='',$offset=''){
        ...
        $this->db->join($this->table_curso.' as h','h.CURSOP_Codigo=c.CURSOP_Codigo','inner'); 
        if(isset($filter->curso) && $filter->curso!='')   $this->db->where(array("h.CURSOP_Codigo"=>$filter->curso));
        if(isset($filter->archivo) && $filter->archivo!='')     $this->db->where(array("c.ARCHIVP_Codigo"=>$filter->tema));
