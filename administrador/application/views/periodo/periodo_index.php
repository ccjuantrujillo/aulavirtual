...
<head>
    ...
    <script type="text/javascript" src="<?php echo js;?>maestros/periodo.js"></script>
</head>
<body>
<div class="contenido" >
    <div class="menu"><ul id="nav"><?php echo $menu;?></ul></div>
    <div class="titulo">
        <input name="" type="button" class="aceptarlog2" alt="Aceptar" title="Aceptar" value="Crear un nuevo periodo" id="nuevo"/>
          ...
          if(count($lista)>0){
            foreach($lista as $item => $value){               
              ...
              <tr class="<?php echo $clase;?>">
                <td><?php echo ++$j;?></td>
                <td align="left" style="text-align:left;"><?php echo $value->descripcion;?></td>
                <td align="left" style="text-align:left;"><?php echo $value->ciclo;?></td>
