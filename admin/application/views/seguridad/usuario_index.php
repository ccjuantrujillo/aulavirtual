...
<div class="container">
        ...
        <?php echo $form_open;?>
            <table class="fuente8" width="98%" cellspacing=0 cellpadding="5" border=0>
                <tr>
                    ...
                    <td align='left'><input id="txtNombres" name="txtNombres" type="text" class="cajaMedia" maxlength="100" value=""></td>
                    <td>&nbsp;</td>
                    <td>&nbsp;</td>
                </tr>
                <tr>
                    <td align='left' width="13%">Usuario</td>
                    <td align='left'><input id="txtUsuario" name="txtUsuario" type="text" class="cajaMedia" maxlength="45" value=""></td>
                    <td>&nbsp;</td>
                    <td>&nbsp;</td>
                </tr>
                <tr>
                    <td align='left' width="13%">Rol</td>
                    <td align='left'><input id="txtRol" name="txtRol" type="text" class="cajaMedia" maxlength="45" value=""></td>
                    <td>&nbsp;</td>
                    <td>&nbsp;</td>
                </tr>
            </table>
    ...
    <div class="case_botones">
        ...
        <ul class="lista_botones"><li id="nuevo" class="ot_listar">Nueva Usuario</li></ul>
