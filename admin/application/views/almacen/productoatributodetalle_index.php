...
<div class="contenido" > 
    ...
    <div class="zonebody patbotom">
        ...
        <div class="titulotabla">
            <input name="" type="button" class="aceptarlog2" alt="Aceptar" title="Aceptar" value="Crear un nuevo pregunta" id="nuevo"/>
            <h1><?php echo $titulo_tabla;?></h1>
            ...
            <div class="mensajetabla">Se han encontrado (<?php echo $registros;?>) registros(s)</div>
                <table  border="1"  cellspacing="0" cellpadding="0">
                  <tr class="list1">
                    ...
                    <td width="86">Video</td>
                    <td width="193">Descripcion de preguntas</td>
