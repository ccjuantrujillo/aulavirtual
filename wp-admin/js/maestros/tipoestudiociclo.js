...
//     });
    ...
    $("#nuevo").click(function(){
        dataString = "";
        url = base_url+"maestros/tipoestudiociclo/editar/n";
...
//    });
    ...
    $('body').on('click',"#cancelar",function(){
        url = base_url+"maestros/tipoestudiociclo/listar";
        location.href = url;
    });
...
//    });
    ...
    $("body").on('click',"#grabar",function(){
        url = base_url+"maestros/tipoestudiociclo/grabar";
        dataString  = $('#frmPersona').serialize();
        $.post(url,dataString,function(data){
            alert('Operacion realizada con exito');
            location.href = base_url+"maestros/tipoestudiociclo/listar";
        });
    });
...
function editar(codigo){
    ...
    url = base_url+"maestros/tipoestudiociclo/editar/e/"+codigo;
    $.post(url,dataString,function(data){
        $('#basic-modal-content').modal();
        $('#mensaje').html(data);
    });
...
function eliminar(codigo){
    if(confirm('Esta seguro desea eliminar este tipo de estudio?')){
        dataString = "codigo="+codigo;
        url = base_url+"maestros/tipoestudiociclo/eliminar";
        $.post(url,dataString,function(data){
//            if(data=="true"){
