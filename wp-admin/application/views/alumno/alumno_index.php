    ...
    <div class="menu"><ul id="nav"><?php echo $menu;?></ul></div>
        ...
        <div class="tabla">    
            <table>
              <tr class="list1">
                <td width="43">No</td>
                <td width="40">Idenfiticador</td>
                <td width="170">Apellidos y Nombres</td>
                <td width="86">Telefono</td>
                <td width="86">Email</td>
                <td width="86">Email Inst.</td>
              ...
              if(count($lista)>0){
                foreach($lista as $item => $value){
                  ...
                  <tr class="<?php echo $clase;?>" id="<?php echo $value->codigo;?>">
                    ...
                    <td align="center"><?php echo $value->identificador;?></td>
                    <td style="text-align: left;"><?php echo $value->paterno." ".$value->materno." ".$value->nombres;?></td>
                    <td style="text-align: left;"><?php echo $value->telefono;?></td>
                    <td style="text-align: left;"><?php echo $value->email;?></td>
                    <td style="text-align: left;"><?php echo $value->emailinst;?></td>
                    <td style="text-align: left;"><?php echo $value->usuario;?></td>
