<div class="contenidotabla" >  
    ...
    <table style="background-color: #f4f7ff">
        <tr>
          <td width="10%" bgcolor="#d5e2f2">Codigo:</td>
          <td width="40%" class="formss"><input name="codigo" id="codigo" type="text" value="<?php echo $lista->codigo;?>" readonly="readonly" class="cajaMinima" style="background-color: #E6E6E6"/></td>
          <td width="10%" bgcolor="#d5e2f2">Identificador:</td>
          <td width="40%" class="formss"><input name="identificador" id="identificador" type="text" value="<?php echo $lista->identificador;?>" class="cajaMedia"/></td>
        </tr>        
        <tr>
