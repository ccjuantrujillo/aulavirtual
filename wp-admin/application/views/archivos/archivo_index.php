...
<head>  
    ...
    <script type="text/javascript" src="<?php echo js;?>almacen/archivo.js"></script>
</head>
<body>
<div class="contenido" > 
    <div class="menu"><ul id="nav"><?php echo $menu;?></ul></div>
    <div class="titulo">
        <input name="" type="button" class="aceptarlog2" alt="Aceptar" title="Aceptar" value="Crear un nuevo archivo" id="nuevo"/>
          ...
          if(count($lista)>0){
            foreach($lista as $item => $value){
              ...
              <tr class="<?php echo $clase;?>">
                ...
                <td align="left"><?php echo $value->leccion;?></td>				
                <td align="left"><?php echo $value->curso;?></td>
                <td align="left"><?php echo $value->adjunto;?></td>
