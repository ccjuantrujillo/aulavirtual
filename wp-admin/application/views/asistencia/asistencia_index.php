...
<head>
    ...
    <script type="text/javascript" src="<?php echo js;?>ventas/asistencia.js"></script>
</head>
<body>
<div class="contenido" >
    <div class="menu"><ul id="nav"><?php echo $menu;?></ul></div>
    <div class="titulo">
        <input name="" type="button" class="aceptarlog2" alt="Aceptar" title="Aceptar" value="Nuevo Asistencia" id="nuevo"/>
